...
public class Batches {
	...
	private LocalDate portfoliosubmissiondate;
	...
	public LocalDate getPortfoliosubmissiondate() {
		return portfoliosubmissiondate;
	}
	public void setPortfoliosubmissiondate(LocalDate portfoliosubmissiondate) {
	...
	public Batches(int batchid, int trainerid, LocalDate enddate, LocalDate portfoliosubmissiondate) {
		super();
		this.batchid = batchid;
		this.trainerid = trainerid;
		this.enddate = enddate;
